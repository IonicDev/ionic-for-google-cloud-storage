 ...
 *
 * Obtained from:
 * https://github.com/GoogleCloudPlatform/google-cloud-java/blob/master/google-cloud-examples/src/
 * main/java/com/google/cloud/examples/storage/snippets/CreateBlob.java
 *
 * Modifications Copyright 2018-2019 Ionic Security.
 */
...
public class GCSCreateBlob {
  ...
  public static void main(String... args) {
    ...
    try {
      ...
      System.err.println(
          "Error: Failed to instantiate an instance of GoogleIonicStorage: " + e.getMessage());
      System.exit(-1);
      return;
    }
    ...
    ionicStorage.setDefaultAttributes(plaintextAttributes);
