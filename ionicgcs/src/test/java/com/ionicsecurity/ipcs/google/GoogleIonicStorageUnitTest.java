...
public class GoogleIonicStorageUnitTest {
    ...
    @BeforeClass
    public static void init() throws IonicException {
    ...
    public void test03_CreateWithTargetOptions() {
        ...
        BlobTargetOption encBtg = BlobTargetOption.encryptionKey(encoder.encodeToString(ionicKeyCreated.getKey()));
    ...
    public void test04_Reader() throws Exception {
        BlobSourceOption encBso = BlobSourceOption.decryptionKey(encoder.encodeToString(ionicKeyFetched.getKey()));
    ...
    public void test05_Writer() throws Exception {
        BlobWriteOption encBwo = BlobWriteOption.encryptionKey(encoder.encodeToString(ionicKeyCreated.getKey()));
